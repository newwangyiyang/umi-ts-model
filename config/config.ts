...
const config: IConfig =  {
  ...
  outputPath: '/ActivityRegister', // 打包的输出路径
  base: '/ActivityRegister/', //指定 react-router 的 base，部署到非根目录时需要配置
  publicPath: '/ActivityRegister/', // 指定 webpack 的 publicPath，指向静态资源文件所在的路径
